...
### NAT Gateways (one per AZ, each in its own public subnet) ###########
# One NAT Gateway per AZ avoids a single point of failure and avoids
# cross-AZ data transfer charges for the private instance in that AZ.
...
# Single public route table shared by both public subnets: 0.0.0.0/0 -> IGW
